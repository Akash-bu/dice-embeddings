...
Example:
    python run_bo_exp.py --report_dataset UMLS KINSHIP
    python run_bo_exp.py --report_dataset KINSHIP --model Keci --loss_fn WaveLoss
    python run_bo_exp.py --report_dataset FB15k-237 --noise_ratio 0.08 --num_epochs 50 --devices 0
"""
...
DATASET_REPORTS = {
    ...
    "NELL-995-h100": _BO_DIR / "missing_val_adv_nell.txt",
    "FB15k-237": _BO_DIR / "missing_val_sem_fb15k.txt",
}
DEFAULT_DATASETS_ROOT = project_root / "Datasets_Perturbed_semantic"

# DEFAULT_DATASETS_ROOT = project_root / "Datasets_Perturbed_adversarial"
...
if __name__ == "__main__":
                ...
                for loss_function, scoring_technique in loss_scoring_pairs:
                    ...
                    for neg_ratio in effective_neg_ratios:
                        ...
                        try:
                            ...
                            all_results[dataset_name][MODEL].setdefault(loss_function, {}).setdefault(
                                scoring_technique, {})[neg_ratio] = test_metrics
    ...
    if all_results:
        ...
        save_results_table(
            df,
            pivot_df,
            project_root / "robust-kge" / "bo_results",
            loss_scoring_pairs,
            models_to_run,
            neg_ratios,
            kind=run_kind,
