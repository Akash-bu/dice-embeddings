...
DBS = ["UMLS"] #, "NELL-995-h100", "FB15k-237", "WN18RR"
...
def _dataset_root_for(loss_function, project_root):
    """Return the adversarial-anomaly Datasets_Perturbed root appropriate for the given loss."""
...
if __name__ == "__main__":
    ...
    if all_results:
        ...
        save_results_table(
            df,
            pivot_df,
            project_root / "robust-kge" / "adv_results",
            loss_scoring_pairs,
            models_to_run,
            neg_ratios,
            kind="Adv",
